    ...
    <>
      <div className="hero-area hero-area-02 hero-area-06 pos-rel">
        <div className="hero_right_img d-none d-lg-block">
          <img className="img-fluid" src="./assets/img/slider/slider6.png" alt="" data-aos={"zoom-in"} />
        </div>
          ...
          <div className="row align-items-center">
            <div className="col-xxl-5 col-xl-5 col-lg-6">
              <div className="hero__content hero__content__02 hero__content__06 text-left">
                <h2 id="header-intro" className="main-title mb-20" data-aos={"fade-up"}>{t("hero.title")}
                </h2>
                <p id="headerAbout" data-aos={"fade-up"}>{t("hero.description")}</p>
                <ul className="btn-list mt-35" data-aos={"fade-up"}>
